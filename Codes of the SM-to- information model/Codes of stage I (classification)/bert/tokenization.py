...
def convert_to_unicode(text):
  ...
  if six.PY3:
    ...
    if isinstance(text, str):
      ...
      return text.decode("utf-8-sig", "ignore")
    else:
...
def convert_by_vocab(vocab, items):
  ...
  output = []
  #print (vocab)
  allvocabsets= list(vocab.items())
  allvocab=[]
  for i in range(0,len(allvocabsets)):
    allvocab.append(allvocabsets[i][0])
  #print (allvocab[0])
  for item in items:
    #print (item)
    if item not in allvocab:
