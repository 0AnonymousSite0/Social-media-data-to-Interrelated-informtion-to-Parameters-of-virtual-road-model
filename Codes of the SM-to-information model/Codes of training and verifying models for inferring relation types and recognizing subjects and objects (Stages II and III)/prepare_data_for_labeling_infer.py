...
def replace_empty_infer_predicate_to_three_possible_values(predicate_score_value):
    ...
    #           '邮政编码', '面积', '首都']
    #label_list = ['Road_status','Lane_status','At','PRIOR',	'PAST',	'Bet', 'LaneOfRoad','Lane_direction','Lane_position','Road_direction','Lane_number']
    label_list = ['Road_status','Lane_status','Road_position','Lane_of_Road','Lane_direction','Lane_position','Road_direction']
    ...
    name_value_three_items = predicate_score_name_value_sort_list[:5]#前10，前5的元素
