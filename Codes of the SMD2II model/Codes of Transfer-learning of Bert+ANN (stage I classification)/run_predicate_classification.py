...
## Required parameters
flags.DEFINE_string(
    "data_dir", r"D:\ZHOUSHENGHUA\PycharmProjects\Entity-Relation-Extraction-master-tweetclassification\bin/predicate_classifiction/classification_data",
    "The input data dir. Should contain the .tsv files (or other data files) "
    "for the task.")
    #D:\ZHOUSHENGHUA\PycharmProjects\Entity-Relation-Extraction-master-tweetclassification\bin/predicate_classifiction/classification_data
flags.DEFINE_string(
    "bert_config_file", r"D:\ZHOUSHENGHUA\PycharmProjects\Entity-Relation-Extraction-master-tweetclassification\pretrained_model/uncased_L-12_H-768_A-12/bert_config.json",
    "The config json file corresponding to the pre-trained BERT model. "
    "This specifies the model architecture.")

flags.DEFINE_string("task_name", "SKE_2019", "The name of the task to train.")
print (flags)
flags.DEFINE_string("vocab_file", r"D:\ZHOUSHENGHUA\PycharmProjects\Entity-Relation-Extraction-master-tweetclassification\pretrained_model/uncased_L-12_H-768_A-12/vocab.txt","pretrained_model/uncased_L-12_H-768_A-12/vocab.txt")

flags.DEFINE_string(
    "output_dir", r"D:\ZHOUSHENGHUA\PycharmProjects\Entity-Relation-Extraction-master-tweetclassification\output/predicate_infer_out/epochs1700/ckpt7031/700",
    "The output directory where the model checkpoints will be written.")

## Other parameters

flags.DEFINE_string(
    "init_checkpoint", r"D:\ZHOUSHENGHUA\PycharmProjects\Entity-Relation-Extraction-master-tweetclassification\output/predicate_classification_model/epochs1700/model.ckpt-7031",
