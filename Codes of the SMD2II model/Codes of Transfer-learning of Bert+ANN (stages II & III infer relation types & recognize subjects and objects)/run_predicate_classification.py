...
flags.DEFINE_string(
    "bert_config_file", r"D:\ZHOUSHENGHUA\PycharmProjects\Entity-Relation-Extraction-master\pretrained_model/uncased_L-12_H-768_A-12/bert_config.json",
    "The config json file corresponding to the pre-trained BERT model. "
    "This specifies the model architecture.")

flags.DEFINE_string("task_name", "SKE_2019", "The name of the task to train.")

flags.DEFINE_string("vocab_file", r"D:\ZHOUSHENGHUA\PycharmProjects\Entity-Relation-Extraction-master\pretrained_model/uncased_L-12_H-768_A-12/vocab.txt","pretrained_model/uncased_L-12_H-768_A-12/vocab.txt")
...
flags.DEFINE_string(
    "init_checkpoint", r"D:\ZHOUSHENGHUA\PycharmProjects\Entity-Relation-Extraction-master\output/predicate_classification_model/epochs700/model.ckpt-1383",
...
class SKE_2019_Multi_Label_Classification_Processor(DataProcessor):
    ...
    def _create_example(self, lines, set_type):
        ...
        for (i, line) in enumerate(lines):
            ...
            if set_type == "test":
                text_str = line
                predicate_label_str = 'Road_status'
            else:
                text_str = line[0]
