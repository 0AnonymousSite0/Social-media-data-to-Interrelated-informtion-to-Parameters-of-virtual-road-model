...
class Sorted_relation_and_entity_list_Management(File_Management):
    ...
    def __init__(self, TEST_DATA_DIR, MODEL_OUTPUT_DIR, Competition_Mode=False):
        ...
        self.relationship_label_list = ['Road_status','Lane_status','Road_position','Lane_of_Road','Lane_direction','Lane_position','Road_direction']
        self.Competition_Mode = Competition_Mode
...
if __name__=='__main__':
    ...
    # TEST_DATA_DIR = "bin/subject_object_labeling/sequence_labeling_data/1416984603735121920/test"
    # #MODEL_OUTPUT_DIR = r"D:\ZHOUSHENGHUA\PycharmProjects\Entity-Relation-Extraction-master\output\sequnce_infer_out\epochs700\ckpt12415\1416984603735121920/"
    # MODEL_OUTPUT_DIR = None
    # OUT_RESULTS_DIR = "output/final_text_spo_list_result/888"
    # Competition_Mode = True
    # print ()
    # spo_list_manager = Sorted_relation_and_entity_list_Management(r"D:\ZHOUSHENGHUA\PycharmProjects\Entity-Relation-Extraction-master\bin\subject_object_labeling\sequence_labeling_data\1416984603735121920\test", r"D:\ZHOUSHENGHUA\PycharmProjects\Entity-Relation-Extraction-master\output\sequnce_infer_out\epochs700\ckpt12415\1416984603735121920/", Competition_Mode=Competition_Mode)
    # spo_list_manager.produce_output_file(OUT_RESULTS_DIR=r"D:\ZHOUSHENGHUA\PycharmProjects\Entity-Relation-Extraction-master/output/final_text_spo_list_result/8888", keep_empty_spo_list=True)