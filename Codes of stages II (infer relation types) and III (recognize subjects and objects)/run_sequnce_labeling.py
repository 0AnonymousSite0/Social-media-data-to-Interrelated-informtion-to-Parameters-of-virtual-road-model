...
flags.DEFINE_string("vocab_file", r"D:\ZHOUSHENGHUA\PycharmProjects\Entity-Relation-Extraction-master\pretrained_model/uncased_L-12_H-768_A-12/vocab.txt",
...
flags.DEFINE_string(
    "init_checkpoint", r"D:\ZHOUSHENGHUA\PycharmProjects\Entity-Relation-Extraction-master\output/sequnce_labeling_model/epochs700/model.ckpt-12415",
    ...
    def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            def metric_fn(predicate_loss, token_label_per_example_loss, predicate_probabilities, token_label_ids, token_label_logits, is_real_example):
                ...
                predicate_loss = tf.compat.v1.metrics.mean (values=predicate_loss)
                return {
